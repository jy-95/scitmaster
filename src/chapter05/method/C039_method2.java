...
public class C039_method2 {
	...
	public static void main(String[] args) {
		...
		method03(3);
		System.out.println(method04(3, 5));
	...
	//파라미터 X, 반환값 X
	//void > 반환할게 없으면 반환하지 않겠다는 의미로 void라는 명시적 표현
	public static void method01() {
		System.out.println("단순 명령어 실행,"
				+ "아무 값도 받아오지 않았고, "
				+ "println만 실행할 뿐 어떤 값도 반환하지 않는다.");
		return; //반환할 값이 없어도 return 사용 가능. break와 같은 기능. 메서드 종료 기능
	}
